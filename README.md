...
- [Command tree](#command-tree)
  ...
  - [Contexts](#contexts)
    ...
    - [Fields Defining a Context](#fields-defining-a-context)
    - [Relationship with Commands](#relationship-with-commands)
    - [Example of Contexts in XML](#example-of-contexts-in-xml)
    - [Navigation Between Contexts](#navigation-between-contexts)
  - [Commands](#commands)
    - [Definition](#definition-1)
    - [Fields Defining a Command](#fields-defining-a-command)
    - [Example of Commands in XML](#example-of-commands-in-xml)
  - [Subcommands](#subcommands)
    - [Definition](#definition-2)
    - [Fields Defining a Subcommand](#fields-defining-a-subcommand)
    - [When to Use a Subcommand vs. a Parameter](#when-to-use-a-subcommand-vs-a-parameter)
    - [Example: Setting an IP Address](#example-setting-an-ip-address)
    - [Example of Subcommands in XML](#example-of-subcommands-in-xml)
  - [Parameters](#parameters)
    - [Definition](#definition-3)
    - [Fields Defining a Parameter](#fields-defining-a-parameter)
    - [Example of Parameters in XML](#example-of-parameters-in-xml)
  - [Relations Between Contexts, Commands, Subcommands, and Parameters](#relations-between-contexts-commands-subcommands-and-parameters)
  - [Implicit Commands](#implicit-commands)
  - [Example: Designing a CLI for a Smart Home System](#example-designing-a-cli-for-a-smart-home-system)
...
- [Callbacks implementation](#callbacks-implementation)
  - [Command Callback](#command-callback)
    ...
    - [Example Callback implementation](#example-callback-implementation)
    - [Navigational Macros](#navigational-macros)
  - [Value Completion Callback](#value-completion-callback)
    - [Parameters](#parameters-2)
    - [Return Value:](#return-value-1)
  - [Error codes](#error-codes)
- [Main Program and Running the CLI](#main-program-and-running-the-cli)
  - [Download and Installation](#download-and-installation)
    - [Cloning the Repository](#cloning-the-repository)
    - [Building libcliminal (TARGET library)](#building-libcliminal-target-library)
      - [Requirements](#requirements)
      - [Build Instructions](#build-instructions)
    - [Installing on the Target Machine](#installing-on-the-target-machine)
    - [Building CliminalBuilder (HOST Tool)](#building-climinalbuilder-host-tool)
      - [Requirements](#requirements-1)
      - [Build Instructions](#build-instructions-1)
    - [Building and Running an Example](#building-and-running-an-example)
      - [Steps](#steps)
    - [Defining Your CLI Structure](#defining-your-cli-structure)
    - [Generating the C Code](#generating-the-c-code)
    - [Main Program and Running the CLI](#main-program-and-running-the-cli-1)
    - [Implementing Callbacks](#implementing-callbacks)
    - [Compiling Your CLI](#compiling-your-cli)
    - [Running Your CLI](#running-your-cli)
- [History Management in Climinal](#history-management-in-climinal)
  - [Listing Command History](#listing-command-history)
    - [Example Usage](#example-usage)
  - [Recalling Commands from History](#recalling-commands-from-history)
    - [Example Usage](#example-usage-1)
  - [Re-executing the Last Command](#re-executing-the-last-command)
    - [Example Usage](#example-usage-2)
  - [Navigating Through History Using Arrow Keys](#navigating-through-history-using-arrow-keys)
    - [Example Usage](#example-usage-3)
  - [Using History for Efficient CLI Interaction](#using-history-for-efficient-cli-interaction)
    - [Example Full Session Using History](#example-full-session-using-history)
  - [Summary of History Commands in Climinal](#summary-of-history-commands-in-climinal)
